...
El programa, al recibir como dato el nivel de un profesor, incrementa su salario en funcion de la tabla 1.3.
...
void main(void)
{
    float SAL;
    int NIV;
    printf("Ingrese el nivel academido del profesor: ");
    scanf("%d", &NIV);
