...
void main(void)
{
    ...
    //Nota que al apuntador a4 esnecesario asignarle una direccion de memoria. Para tener acceso a los campos de un apuntador de tipo estructura, utiliza uno de losdos formatos siguientes:
...
//Esta funcion permite leer los campos de un apuntador de tipo estructura alumno.carrera
{
