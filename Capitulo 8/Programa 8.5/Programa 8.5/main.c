...
void main(void)
{
    ...
    //Para que puedas observar las diferentes formas en que los campos de las variables de tipo estructura alumno reciben valores, ningresamos los valores de los campos de tres formas diferentes. Los campos de a1 reciben valores directamente, los campos de a2 se leen en el programa principal, y los campos de a3 reciben valores a traves de una funcion.
    printf("Alumno 2\n");
    ...
    puts(a2.carrera);
    printf("%.2f\n", a2.promedio);
    puts(a1.personales.correo);             //Escribe el contenido del segundo campo.
