...
struct alumno           //Declaracion de la estrfuctura.
{
    int matricula;
    char nombre[20];
...
void main(void)
{
    ...
    //Los campos de a1 recibe valores directamente.
    ...
    gets(a2.carrera);
    printf("ingrese el nombre del alumno 2: ");
    printf("%f", &a2.promedio);
    fflush(stdin);
    printf("ingrese el nombre del alumno 2: ");
    gets(a2.direccion);

    //Los campos de a3 reciben los valores por medio de asignaciones.
