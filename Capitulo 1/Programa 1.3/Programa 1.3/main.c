...
/* Promedio de sueldos.
E programa, al recibir como datos seis sueldos de un empleado, calcula tanto el ingreso total como el promedio mensual.
...
void main(void)
{
    ...
    printf("Ingrese la clave ddl empleado y los 6 sueldos: \n");
