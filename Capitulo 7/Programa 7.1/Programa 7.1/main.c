...
//Funciones para el manejo de caracteres de la bibliioteca stdio.h.
...
void main(void)
{
    ...
    printf("\nEl caracter p3 es: ");
    putchar(p3);
    //Se utiliza la funcion putchat para escribir el caracter almacenado en p3.
    printf("\n");
    printf("\nIngrese otro caracter: ");
    fflush(stdin);
    scanf("%c", &p2);
    //Se puede utilizar sacnf con el formato de variable %c para leer un caracter.
    printf("%c", &p2);
