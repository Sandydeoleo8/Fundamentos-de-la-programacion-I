...
void main(void)
{
    ...
    printf("\n\nCandidato 1: %d votos -- Prcentaje: %5.2f", C1, PO1);
    printf("\nCandidato 2: %d votos -- Prcentaje: %5.2f", C2, PO2);
    printf("\nCandidato 3: %d votos -- Prcentaje: %5.2f", C3, PO3);
    printf("\nCandidato 4: %d votos -- Prcentaje: %5.2f", C4, PO4);
    printf("\nCandidato 5: %d votos -- Prcentaje: %5.2f", C5, PO5);
    printf("\nNulos: %d votos -- Prcentaje: %5.2f", NU, PON);
